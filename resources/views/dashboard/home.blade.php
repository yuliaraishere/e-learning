                        ...
                        <div class="bg-primary b-r-4 card-body">
                            <div class="media static-top-widget">
                                ...
                                <div class="media-body">
                                    <span class="m-0">Study Hours</span>
                    ...
                    <div class="card o-hidden border-0">
                        <div class="bg-secondary b-r-4 card-body">
                            <div class="media static-top-widget">
                                ...
                                <div class="media-body">
                                    <span class="m-0">Certificate</span>
                                    <h4 class="mb-0 counter">15</h4>
                    ...
                    <div class="card o-hidden border-0">
                        <div class="bg-warning b-r-4 card-body">
                            <div class="media static-top-widget">
                                ...
                                <div class="media-body">
                                    <span class="m-0">Active Diklat</span>
                            ...
                            <div class="card-body">
                                <div class="media">
                                    ...
                                    <div class="media-body align-self-center text-white">
                                        <h4 class="m-0 f-w-600 num">31°C</h4>
                                        <p class="m-0 f-14">Jakarta</p>
                                    </div>
                                </div>
                                <div class="media">
